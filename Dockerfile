...
ENTRYPOINT ["/bin/bash", "-c", "source /catkin_ws/devel/setup.bash && (roslaunch tortoisebot_waypoints tortoisebot_playground_headless.launch &) && sleep 20 && rostest tortoisebot_waypoints waypoints_test.test -r"]
